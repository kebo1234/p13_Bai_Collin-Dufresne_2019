...
Figure~\ref{fig:figure1} shows the dispersion of the CDS-bond basis over time, separated by credit rating. Panel (a) displays investment-grade bonds, while panel (b) shows high-yield bonds. The blue line represents the median basis, while the red dotted lines show the 10th and 90th percentiles.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{_output/figure1_basis_timeseries.pdf}
    \caption{Dispersion of the CDS-bond basis by credit rating: (a) Investment-grade bonds and (b) high-yield bonds. The median basis is shown in blue, with 10th and 90th percentiles in red.}
    \label{fig:figure1}
\end{figure}
...
\input{_output/table1_summary_statistics.tex}
