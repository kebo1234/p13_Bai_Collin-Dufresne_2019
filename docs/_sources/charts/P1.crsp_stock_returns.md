...
tags: CRSP Stock File (CIZ format)
category: 
---

# Chart: Average Monthly Stock Returns
Average monthly stock returns from CRSP CIZ data.

## Chart
```{raw} html
<iframe src="../_static/P1/crsp_stock_returns.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: CRSP Stock File (CIZ format)</p>
```
[Full Screen Chart](../download_chart/P1/crsp_stock_returns.html)





Exploratory chart of average monthly stock returns from CRSP CIZ data.
...
| Seasonal Adjustment    |                                     |
| Units                  |                                                   |
| HTML Chart             | [HTML](../download_chart/P1/crsp_stock_returns.html)    |
